        ...
        var t, e = {
                ...
                srgd: function(t, e, n) {
                    ...
                    function v(t) {
                        ...
                        let n = e.join("/");
                        return t.quality && (n += d(t)), t.unsharpMask && (n += p(t.unsharpMask)), t.progressive || (n += g(t)), t.watermark && (n += m(t)), t.filters && (n += Object.keys(t.filters).map(e => b[e](t.filters)).join("")), t.fileType !== i.r5.GIF && (t.encoding === i.DG.AVIF ? (n += E(t), n += h(t)) : t.encoding === i.DG.PAVIF ? (n += y(t), n += h(t)) : t.autoEncode && (n += T(t))), t.src ? .isAnimated && t.transformed && (n += _(t)), `${t.src.id}/${i.Gn}/${n}/${t.fileName}.${t.preferredExtension}`
                    }
                },
                Pxdx: function(t, e, n) {
                    "use strict";
                ...
                bEQy: function(t, e, n) {
                    ...
                    function y(t, e, n, o, s, a) {
                        ...
                        const {
                            ...
                            let s, a = n,
                                c = i;
                            if (s = E(t, e, n, i, o), o === r.BD.FIT && (a = t * s, c = e * s), a && c && a * c > r.zL) {
                                const n = Math.sqrt(r.zL / (a * c));
                                a *= n, c *= n, s = E(t, e, a, c, o)
                            }
                            return {
                                scaleFactor: s,
                                width: a,
                ...
                JgJM: function(t, e, n) {
                    ...
                    t.exports = function(t) {
                        return new Promise(function(e, n) {
                            ...
                            if (p.open(t.method.toUpperCase(), s(b, t.params, t.paramsSerializer), !0), p.timeout = t.timeout, "onloadend" in p ? p.onloadend = T : p.onreadystatechange = function() {
                                    p && 4 === p.readyState && (0 !== p.status || p.responseURL && 0 === p.responseURL.indexOf("file:")) && setTimeout(T)
                                }, p.onabort = function() {
                                ...
                                var E = (t.withCredentials || u(b)) && t.xsrfCookieName ? o.read(t.xsrfCookieName) : void 0;
...
//# sourceMappingURL=https://static.parastorage.com/services/editor-elements-library/dist/corvid/rb_wixui.corvid[ClassicSection].585e393a.bundle.min.js.map