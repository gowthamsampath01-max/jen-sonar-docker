    ...
    return function() {
        ...
        return function() {
            ...
            const a = "wixui-",
                c = (e, ...t) => {
                    const n = [];
                    return e && n.push(`${a}${e}`), t.forEach(e => {
            ...
            const v = e => {
                ...
                return n.createElement("div", t()({
                    id: r,
                    className: s(i, c(p.root, ...u))
                }, (e => Object.entries(e).reduce((e, [t, n]) => (t.includes("data-") && (e[t] = n), e), {}))(e), ((e = {}) => {
            ...
            const x = {
                FiveGridLine_SolidLine: {
                    component: e => {
                        ...
                        return i().createElement(v, t()({}, r, {
                            className: s(r.className, b)
                        }))
                    }
                }
            }
