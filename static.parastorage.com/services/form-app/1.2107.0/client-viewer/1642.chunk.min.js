    ...
    [1642], {
        61642: (t, e, n) => {
            ...
            var o = ["input:not([inert])", "select:not([inert])", "textarea:not([inert])", "a[href]:not([inert])", "button:not([inert])", "[tabindex]:not(slot):not([inert])", "audio[controls]:not([inert])", "video[controls]:not([inert])", '[contenteditable]:not([contenteditable="false"]):not([inert])', "details>summary:first-of-type:not([inert])", "details:not([inert])"],
                ...
                l = !i && Element.prototype.getRootNode ? function(t) {
                    var e;
                        ...
                        if (!u(d, !1))
                            if ("SLOT" === d.tagName) {
                                var c = d.assignedElements(),
                                    f = t(c.length ? c : d.children, !0, o);
                                o.flatten ? i.push.apply(i, f) : i.push({
                                    scopeParent: d,
                                    candidates: f
                                })
                            } else {
                                a.call(d, r) && o.filter(d) && (n || !e.includes(d)) && i.push(d);
                                var s = d.shadowRoot || "function" == typeof o.getShadowRoot && o.getShadowRoot(d),
                                    p = !u(s, !1) && (!o.shadowRootFilter || o.shadowRootFilter(d));
                                if (s && p) {
                                    var h = t(!0 === s ? d.children : s.children, !0, o);
                                    o.flatten ? i.push.apply(i, h) : i.push({
                                        scopeParent: d,
                                        candidates: h
                                    })
                                } else l.unshift.apply(l, d.children)
                            }
                    }
                    return i
                },
                    ...
                    if (n && "full" !== n && "legacy-full" !== n) {
                        ...
                        if ("function" == typeof o) {
                            for (var i = t; t;) {
                                var u = t.parentElement,
                                    d = l(t);
                                if (u && !u.shadowRoot && !0 === o(u)) return m(t);
                        ...
                        if (function(t) {
                                var e, n, o, r, i = t && l(t),
                                    ...
                                    u = !1;
                                if (i && i !== t)
                                    for (u = !!(null !== (n = a) && void 0 !== n && null !== (o = n.ownerDocument) && void 0 !== o && o.contains(a) || null != t && null !== (r = t.ownerDocument) && void 0 !== r && r.contains(t)); !u && a;) {
                                        var d, c, f;
                                        u = !(null === (c = a = null === (d = i = l(a)) || void 0 === d ? void 0 : d.host) || void 0 === c || null === (f = c.ownerDocument) || void 0 === f || !f.contains(a))
                                    }
                                return u
                            ...
                            for (var e = t.parentElement; e;) {
                                if ("FIELDSET" === e.tagName && e.disabled) {
                                    for (var n = 0; n < e.children.length; n++) {
                                        ...
                                        if ("LEGEND" === o.tagName) return !!a.call(e, "fieldset[disabled] *") || !o.contains(t)
                                    }
                                    return !0
                                }
                                e = e.parentElement
                ...
                b = function t(e) {
                    ...
                    }), o.sort(p).reduce(function(t, e) {
                        return e.isScope ? t.push.apply(t, e.content) : t.push(e.content), t
                    }, []).concat(n)
                },
                E = function(t, e) {
                    var n;
                    return n = (e = e || {}).getShadowRoot ? c([t], e.includeContainer, {
                        filter: y.bind(null, e),
                        flatten: !1,
                        getShadowRoot: e.getShadowRoot,
                        shadowRootFilter: S
                    }) : d(t, e.includeContainer, y.bind(null, e)), b(n)
                },
                N = function(t, e) {
                    return (e = e || {}).getShadowRoot ? c([t], e.includeContainer, {
                        filter: w.bind(null, e),
                        flatten: !0,
                        getShadowRoot: e.getShadowRoot
                    }) : d(t, e.includeContainer, w.bind(null, e))
                },
                R = function(t, e) {
                    if (e = e || {}, !t) throw new Error("No node provided");
                    return !1 !== a.call(t, r) && y(e, t)
                },
                I = o.concat("iframe").join(","),
                A = function(t, e) {
                    if (e = e || {}, !t) throw new Error("No node provided");
                    return !1 !== a.call(t, I) && w(e, t)
                }
        }
    }
]);
