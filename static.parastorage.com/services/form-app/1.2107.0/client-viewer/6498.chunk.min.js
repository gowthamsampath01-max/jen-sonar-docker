                ...
                h = function(e, t) {
                    var n, r = (null == t ? void 0 : t.document) || document,
                        ...
                        N = function(e) {
                            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                                ...
                                u = void 0 === a ? [] : a,
                                s = i[e];
                            if ("function" == typeof s && (s = s.apply(void 0, c(u))), !0 === s && (s = void 0), !s) {
                            ...
                            if ("string" == typeof s) {
                                ...
                                if (!l && !o) throw new Error("`".concat(e, "` as selector refers to no known node"))
                            }
                            return l
                        },
                        F = function() {
                            ...
                            if (!1 === e) return !1;
                            if (void 0 === e || e && !(0, o.EB)(e, i.tabbableOptions))
                                if (g(r.activeElement) >= 0) e = r.activeElement;
                                else {
                                    var t = h.tabbableGroups[0];
                                    e = t && t.firstTabbableNode || N("fallbackFocus")
                                }
                            else null === e && (e = N("fallbackFocus"));
                        ...
                        O = function() {
                            if (h.containerGroups = h.containers.map(function(e) {
                                    var t = (0, o.ht)(e, i.tabbableOptions),
                                        n = (0, o.KW)(e, i.tabbableOptions),
                                ...
                                }), h.tabbableGroups.length <= 0 && !N("fallbackFocus")) throw new Error("Your focus-trap must have at least one container with at least one tabbable node in it at all times");
                        ...
                        k = function(e) {
                            !1 !== e && e !== E(document) && (e && e.focus ? (e.focus({
                        ...
                        D = function(e) {
                            ...
                            if (h.tabbableGroups.length > 0) {
                                ...
                                if (c < 0) u = a ? h.tabbableGroups[h.tabbableGroups.length - 1].lastTabbableNode : h.tabbableGroups[0].firstTabbableNode;
                                    ...
                                    if (l < 0 && (s.container === t || (0, o.EB)(t, i.tabbableOptions) && !(0, o.Wq)(t, i.tabbableOptions) && !s.nextTabbableNode(t, !1)) && (l = c), l >= 0) {
                                        var f = 0 === l ? h.tabbableGroups.length - 1 : l - 1,
                                            b = h.tabbableGroups[f];
                                        u = (0, o.pN)(t) >= 0 ? b.lastTabbableNode : b.lastDomTabbableNode
                                    } else d(n) || (u = s.nextTabbableNode(t, !1))
                                } else {
                                    var v = h.tabbableGroups.findIndex(function(e) {
                                        var n = e.lastTabbableNode;
                                        return t === n
                                    });
                                    if (v < 0 && (s.container === t || (0, o.EB)(t, i.tabbableOptions) && !(0, o.Wq)(t, i.tabbableOptions) && !s.nextTabbableNode(t)) && (v = c), v >= 0) {
                                        var p = v === h.tabbableGroups.length - 1 ? 0 : v + 1,
                                            y = h.tabbableGroups[p];
                                        u = (0, o.pN)(t) >= 0 ? y.firstTabbableNode : y.firstDomTabbableNode
                                    } else d(n) || (u = s.nextTabbableNode(t))
                                }
                            } else u = N("fallbackFocus");
                            return u
                        },
                        P = function(e) {
                            var t = m(e);
                            g(t, e) >= 0 || (p(i.clickOutsideDeactivates, e) ? n.deactivate({
                                returnFocus: i.returnFocusOnDeactivate
                            }) : p(i.allowOutsideClick, e) || e.preventDefault())
                        },
                        G = function(e) {
                            var t = m(e),
                                n = g(t, e) >= 0;
                            if (n || t instanceof Document) n && (h.mostRecentlyFocusedNode = t);
                                ...
                                if (h.mostRecentlyFocusedNode)
                                    if ((0, o.pN)(h.mostRecentlyFocusedNode) > 0) {
                                        var u = g(h.mostRecentlyFocusedNode),
                                            c = h.containerGroups[u].tabbableNodes;
                                        if (c.length > 0) {
                                            var s = c.findIndex(function(e) {
                                                return e === h.mostRecentlyFocusedNode
                                            });
                                            s >= 0 && (i.isKeyForward(h.recentNavEvent) ? s + 1 < c.length && (r = c[s + 1], a = !1) : s - 1 >= 0 && (r = c[s - 1], a = !1))
                                        }
                                ...
                                a && (r = D({
                                    ...
                                    isBackward: i.isKeyBackward(h.recentNavEvent)
                                })), k(r || (h.mostRecentlyFocusedNode || F()))
                            }
                        ...
                        x = function(e) {
                            (i.isKeyForward(e) || i.isKeyBackward(e)) && function(e) {
                                ...
                                n && (d(e) && e.preventDefault(), k(n))
                            }(e, i.isKeyBackward(e))
                        },
                        R = function(e) {
                            var t;
                            "Escape" !== (null == (t = e) ? void 0 : t.key) && "Esc" !== (null == t ? void 0 : t.key) && 27 !== (null == t ? void 0 : t.keyCode) || !1 === p(i.escapeDeactivates, e) || (e.preventDefault(), n.deactivate())
                        },
                        I = function(e) {
                            var t = m(e);
                            g(t, e) >= 0 || p(i.clickOutsideDeactivates, e) || p(i.allowOutsideClick, e) || (e.preventDefault(), e.stopImmediatePropagation())
                        },
                        j = function() {
                            if (h.active) return s(a, n), h.delayInitialFocusTimer = i.delayInitialFocus ? v(function() {
                                k(F())
                            }) : k(F()), r.addEventListener("focusin", G, !0), r.addEventListener("mousedown", P, {
                                capture: !0,
                                passive: !1
                                ...
                                capture: !0,
                                passive: !1
                            }), r.addEventListener("keydown", R), n
                        },
                        A = function() {
                            if (h.active) return r.removeEventListener("focusin", G, !0), r.removeEventListener("mousedown", P, !0), r.removeEventListener("touchstart", P, !0), r.removeEventListener("click", I, !0), r.removeEventListener("keydown", x, !0), r.removeEventListener("keydown", R), n
                        },
                        B = "undefined" != typeof window && "MutationObserver" in window ? new MutationObserver(function(e) {
                            e.some(function(e) {
                        ...
                        L = function() {
                            B && (B.disconnect(), h.active && !h.paused && h.containers.map(function(e) {
                                B.observe(e, {
                                    subtree: !0,
                                    childList: !0
                                })
                    ...
                    return (n = {
                        ...
                        deactivate: function(e) {
                            ...
                            clearTimeout(h.delayInitialFocusTimer), h.delayInitialFocusTimer = void 0, A(), h.active = !1, h.paused = !1, L(), l(a, n);
                            var o = w(t, "onDeactivate"),
                                r = w(t, "onPostDeactivate"),
                                c = w(t, "checkCanReturnFocus"),
                                s = w(t, "returnFocus", "returnFocusOnDeactivate");
                            null == o || o();
                            var d = function() {
                                v(function() {
                                    s && k(T(h.nodeFocusedBeforeActivation)), null == r || r()
                                })
                            };
                            return s && c ? (c(T(h.nodeFocusedBeforeActivation)).then(d, d), this) : (d(), this)
                        },
                        pause: function(e) {
                            if (h.paused || !h.active) return this;
                            var t = w(e, "onPause"),
                                n = w(e, "onPostPause");
                            return h.paused = !0, null == t || t(), A(), L(), null == n || n(), this
                        },
                        unpause: function(e) {
                            if (!h.paused || !h.active) return this;
                            var t = w(e, "onUnpause"),
                                n = w(e, "onPostUnpause");
                            return h.paused = !1, null == t || t(), O(), j(), L(), null == n || n(), this
                        },
